...
void myDisplay()
{
	...
	//1,2�� ����: XZ�̵� + y�� ����
	glm::mat4 M = glm::mat4(1.0f); //�ʱ����
	M = glm::translate(M, glm::vec3(BaseTransX, 0.0f, BaseTransZ)); //�κ� ������ XZ��鿡�� �̵�
	M = glm::rotate(M, glm::radians(BaseSpin), glm::vec3(0.0f, 1.0f, 0.0f)); //������ y�� �������� BaseSpin ȸ��

	DrawBase(M); //base �׸���

	//shoulder ������ǥ
	glm::mat4 M_shoulder = M; //���̽� ���� ����Ʈ �ø���
	...
	DrawArmSegment(M_shoulder); //shoulder �׸���
	...
	teapotLocal = glm::translate(teapotLocal, glm::vec3(0.0f, 0.18f, 0.0f)); //wrist �ణ ���� �ø���
...
void initGL(GLFWwindow** window)
{
	...
	// --------------------
	* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "The  dhe Arm", NULL, NULL);
	if (window == NULL)
	{
