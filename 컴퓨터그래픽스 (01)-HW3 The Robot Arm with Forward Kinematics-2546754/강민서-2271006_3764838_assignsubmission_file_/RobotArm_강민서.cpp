...
void myDisplay()
{
	...
	// 손가락1 끝부분
	glm::mat4 Finger1 = glm::translate(finger1, glm::vec3(0.0f, 0.3f, 0.0f));
	Finger1 = glm::rotate(Finger1, glm::radians(FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerTip(Finger1);
	...
	// 손가락2 끝부분
	glm::mat4 Finger2 = glm::translate(finger2, glm::vec3(0.0f, 0.3f, 0.0f));
	Finger2 = glm::rotate(Finger2, glm::radians(-FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerTip(Finger2);
