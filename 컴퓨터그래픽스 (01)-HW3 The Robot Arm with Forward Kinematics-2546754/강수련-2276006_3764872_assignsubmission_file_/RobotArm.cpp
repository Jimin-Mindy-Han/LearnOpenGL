...
void myDisplay()
{
	...
	glm::mat4 FirstArmSegment = BaseModel;
	FirstArmSegment = glm::translate(FirstArmSegment,glm::vec3(0.0f,0.4f,0.0f));
	FirstArmSegment = glm::rotate(FirstArmSegment,glm::radians(ShoulderAng),glm::vec3(0.0f,0.0f,1.0f));
	DrawArmSegment(FirstArmSegment);

	
	glm::mat4 SecondArmSegment = FirstArmSegment; 
	SecondArmSegment = glm::translate(SecondArmSegment,glm::vec3(0.0f,0.5f,0.0f));
	SecondArmSegment = glm::rotate(SecondArmSegment,glm::radians(ElbowAng),glm::vec3(0.0f, 0.0f, 1.0f));
	DrawArmSegment(SecondArmSegment);

	
	glm::mat4 ThirdArmSegment = SecondArmSegment; 
	ThirdArmSegment = glm::translate(ThirdArmSegment,glm::vec3(0.0f,0.5f,0.0f));
	ThirdArmSegment = glm::rotate(ThirdArmSegment,glm::radians(WristAng),glm::vec3(0.0f,0.0f,1.0f));
	ThirdArmSegment = glm::rotate(ThirdArmSegment,glm::radians(WristTwistAng),glm::vec3(0.0f,1.0f,0.0f));
	DrawWrist(ThirdArmSegment);

	glm::mat4 FourthArmSegment = glm::translate(ThirdArmSegment,glm::vec3(0.0f,0.2f,0.0f));

	glm::mat4 Finger1 = glm::rotate(FourthArmSegment,glm::radians(FingerAng1),glm::vec3(0.0f,0.0f,1.0f));
	DrawFingerBase(Finger1);

	glm::mat4 Finger2 = glm::rotate(FourthArmSegment,glm::radians(FingerAng2),glm::vec3(0.0f,0.0f,1.0f));
