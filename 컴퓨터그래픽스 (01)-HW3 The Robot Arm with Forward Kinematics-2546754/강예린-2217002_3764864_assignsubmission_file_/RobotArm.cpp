...
void myDisplay()
{
	...
	glm::mat4 model_base = glm::translate(glm::mat4(1.0f), glm::vec3(BaseTransX, 0.0f, BaseTransZ));
	model_base = glm::rotate(model_base, glm::radians(BaseSpin), glm::vec3(0.0f, 1.0f, 0.0f));
	DrawBase(model_base);

	glm::mat4 model_upper_arm = glm::translate(model_base, glm::vec3(0.0f, 0.4f, 0.0f));
	model_upper_arm = glm::rotate(model_upper_arm, glm::radians(ShoulderAng), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawArmSegment(model_upper_arm);

	glm::mat4 model_forearm = glm::translate(model_upper_arm, glm::vec3(0.0f, 0.5f, 0.0f));
	model_forearm = glm::rotate(model_forearm, glm::radians(ElbowAng), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawArmSegment(model_forearm);

	glm::mat4 model_wrist = glm::translate(model_forearm, glm::vec3(0.0f, 0.5f, 0.0f));
	...
	DrawWrist(model_wrist);

	glm::mat4 finger_base_transform = glm::translate(model_wrist, glm::vec3(0.0f, 0.2f, 0.0f));

	glm::mat4 model_finger1 = finger_base_transform; 
	model_finger1 = glm::rotate(model_finger1, glm::radians(FingerAng1), glm::vec3(1.0f, 0.0f, 0.0f));
	DrawFingerBase(model_finger1);

	model_finger1 = glm::translate(model_finger1, glm::vec3(0.0f, 0.35f, 0.0f));
	model_finger1 = glm::rotate(model_finger1, glm::radians(FingerAng2), glm::vec3(1.0f, 0.0f, 0.0f));
	DrawFingerTip(model_finger1);

	glm::mat4 model_finger2 = finger_base_transform;
	model_finger2 = glm::rotate(model_finger2, glm::radians(-45.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	model_finger2 = glm::rotate(model_finger2, glm::radians(FingerAng1), glm::vec3(1.0f, 0.0f, 0.0f));
	DrawFingerBase(model_finger2);

	model_finger2 = glm::translate(model_finger2, glm::vec3(0.0f, 0.35f, 0.0f));
	model_finger2 = glm::rotate(model_finger2, glm::radians(FingerAng2), glm::vec3(1.0f, 0.0f, 0.0f));
	DrawFingerTip(model_finger2);
