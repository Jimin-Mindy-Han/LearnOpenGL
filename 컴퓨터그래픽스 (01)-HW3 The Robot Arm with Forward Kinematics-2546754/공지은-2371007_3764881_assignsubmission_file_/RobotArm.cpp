...
void myDisplay()
{
	...
	model = glm::rotate(model, BaseSpin/60.0f, glm::vec3(0.0f, 1.0f, 0.0f));
	
	DrawBase(model);
	
	model = glm::translate(model, glm::vec3(0.0f, 0.4f, 0.0f));
	model = glm::rotate(model, ShoulderAng/60.0f, glm::vec3(0.0f, 0.0f, 1.0f));
	
	DrawArmSegment(model);
	model = glm::translate(model, glm::vec3(0.0f, 0.5f, 0.0f));
	model = glm::rotate(model, ElbowAng/60.0f, glm::vec3(0.0f, 0.0f, 1.0f));

	DrawArmSegment(model);

	model = glm::translate(model, glm::vec3(0.0f, 0.55f, 0.0f));
	model = glm::rotate(model, WristAng / 60.0f, glm::vec3(0.0f, 0.0f, 1.0f));
	model = glm::rotate(model, WristTwistAng / 60.0f, glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::rotate(model, 90.0f / 60.0f, glm::vec3(0.0f, 1.0f, 0.0f));

	DrawWrist(model);

	model = glm::translate(model, glm::vec3(0.0f, 0.2f, 0.0f));
	model = glm::rotate(model, -FingerAng1 / 60.0f, glm::vec3(1.0f, 0.0f, 0.0f));
	...
	model = glm::rotate(model, FingerAng2 / 60.0f, glm::vec3(1.0f, 0.0f, 0.0f));
