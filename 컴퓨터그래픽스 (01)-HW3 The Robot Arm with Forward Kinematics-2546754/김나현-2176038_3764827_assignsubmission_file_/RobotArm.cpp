...
void myDisplay()
{
	...
	void myDisplay();
	{
		...
		//shoulder
		glm::mat4 shoulder = glm::translate(base, glm::vec3(0.0f, 0.25f, 0.0f));
		shoulder = glm::rotate(shoulder, glm::radians(ShoulderAng), glm::vec3(0, 0, 1));
		DrawArmSegment(shoulder);

		//elbow
		glm::mat4 elbow = glm::translate(shoulder, glm::vec3(0.0f, 0.45f, 0.0f));
		elbow = glm::rotate(elbow, glm::radians(ElbowAng), glm::vec3(0, 0, 1));
		DrawArmSegment(elbow);

		//wrist
		glm::mat4 wrist = glm::translate(elbow, glm::vec3(0.0f, 0.45f, 0.0f));
		wrist = glm::rotate(wrist, glm::radians(WristAng), glm::vec3(0, 0, 1));
		DrawWrist(wrist);

		//finger
		glm::mat4 finger1 = glm::translate(wrist, glm::vec3(0.1f, 0.2f, 0.0f));
		finger1 = glm::rotate(finger1, glm::radians(FingerAng1), glm::vec3(0, 0, 1));
		DrawFingerBase(finger1);

		glm::mat4 finger2 = glm::translate(wrist, glm::vec3(-0.1f, 0.2f, 0.0f));
		finger2 = glm::rotate(finger2, glm::radians(FingerAng2), glm::vec3(0, 0, 1));
