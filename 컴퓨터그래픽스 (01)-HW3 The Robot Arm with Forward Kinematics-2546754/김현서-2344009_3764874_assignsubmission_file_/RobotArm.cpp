...
void myDisplay()
{
    ...
    //base
    glm::mat4 baseXform = glm::rotate(glm::translate(glm::mat4(1.0f), glm::vec3(BaseTransX, 0.0f, BaseTransZ)), glm::radians(BaseSpin), glm::vec3(0.0f, 1.0f, 0.0f));
    DrawBase(baseXform);
    
    //first arm
    glm::mat4 arm1Start = glm::translate(baseXform, glm::vec3(0.0f, 0.4f, 0.0f));
    glm::mat4 arm1Xform = glm::rotate(arm1Start, glm::radians(ShoulderAng), glm::vec3(0.0f, 0.0f, 1.0f));
    DrawArmSegment(arm1Xform);

    //second arm
    glm::mat4 arm2Start = glm::translate(arm1Xform, glm::vec3(0.0f, 0.5f, 0.0f));
    glm::mat4 arm2Xform = glm::rotate(arm2Start, glm::radians(ElbowAng), glm::vec3(0.0f, 0.0f, 1.0f));
    DrawArmSegment(arm2Xform);
    
    //wrist
    glm::mat4 wristStart = glm::translate(arm2Xform, glm::vec3(0.0f, 0.5f, 0.0f));
    glm::mat4 wristXform = glm::rotate(wristStart, glm::radians(WristAng), glm::vec3(0.0f, 0.0f, 1.0f));
    wristXform = glm::rotate(wristXform, glm::radians(WristTwistAng), glm::vec3(0.0f, 1.0f, 0.0f)); //twist
    DrawWrist(wristXform);

    //left finger base
    glm::mat4 leftFingerbaseStart = glm::translate(wristXform, glm::vec3(0.0f, 0.2f, 0.0f));
    glm::mat4 leftFingerbaseXform = glm::rotate(leftFingerbaseStart, glm::radians(FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
    DrawFingerBase(leftFingerbaseXform);
    
    //left finget tip
    glm::mat4 leftFingertipStart = glm::translate(leftFingerbaseXform, glm::vec3(0.0f, 0.35f, 0.0f));
    glm::mat4 leftFingertipXform = glm::rotate(leftFingertipStart, glm::radians(FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
    DrawFingerTip(leftFingertipXform);
    
    //right finger base
    glm::mat4 rightFingerbaseStart = glm::translate(wristXform, glm::vec3(0.0f, 0.2f, 0.0f));
    glm::mat4 rightFingerbaseXform = glm::rotate(rightFingerbaseStart, glm::radians(-FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
    DrawFingerBase(rightFingerbaseXform);
    
    //right finget tip
    glm::mat4 rightFingertipStart = glm::translate(rightFingerbaseXform, glm::vec3(0.0f, 0.35f, 0.0f));
    glm::mat4 rightFingertipXform = glm::rotate(rightFingertipStart, glm::radians(-FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
    DrawFingerTip(rightFingertipXform);
