//2371030 민지인
//컴파일을 위해 LearnOpenGL의 cmake, congifuration, includes, lib, src(glad.c, stb_image.cpp만 남김) 
//폴더를 RobotArm.cpp가 있는 위치에 복사 붙여넣기 했습니다! 
//CMakeLists.txt 역시 LearnOpenGL의 CMakeLists를 변형했습니다.
...
void myDisplay()
{
	...
	glm::mat4 fingerBaseModel1 = glm::translate(wristModel, glm::vec3(0.0f, 0.2f, 0.0f));
	glm::mat4 fingerBaseModel2 = glm::translate(wristModel, glm::vec3(0.0f, 0.2f, 0.0f));
	fingerBaseModel1 = glm::rotate(fingerBaseModel1, glm::radians(FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
	fingerBaseModel2 = glm::rotate(fingerBaseModel2, glm::radians(-FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerBase(fingerBaseModel1);
	DrawFingerBase(fingerBaseModel2);

	glm::mat4 fingerTipModel1 = glm::translate(fingerBaseModel1, glm::vec3(0.0f, 0.35f, 0.0f));
	glm::mat4 fingerTipModel2 = glm::translate(fingerBaseModel2, glm::vec3(0.0f, 0.35f, 0.0f));
	fingerTipModel1 = glm::rotate(fingerTipModel1, glm::radians(FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
