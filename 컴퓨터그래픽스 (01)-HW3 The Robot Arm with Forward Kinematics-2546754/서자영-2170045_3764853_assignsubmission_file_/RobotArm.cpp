// 2170045 컴퓨터공학과 서자영 HW3
// extra credit 수행하였습니다.
...
void myDisplay()
{
	...
	if (toggle != attached) {
		if (toggle) {
			teapot = glm::inverse(wrist) * objectXform;
		}
		attached = toggle;
	}

	if (attached) {
		objectXform = wrist * teapot;
	}
