...
void myDisplay()
{
	...
	//왼쪽 손가락 (Wrist relative)
	glm::mat4 LeftFinger = glm::translate(WristModel, glm::vec3(0.08f, 0.15f, 0.0f));
	...
	LeftTip = glm::rotate(LeftTip, glm::radians(FingerAng2), glm::vec3(0, 0, 1));
	DrawFingerTip(LeftTip);

	//오른쪽 손가락 (Wrist relative0
	glm::mat4 RightFinger = glm::translate(WristModel, glm::vec3(-0.08f, 0.15f, 0.0f));
	RightFinger = glm::rotate(RightFinger, glm::radians(-FingerAng1), glm::vec3(0, 0, 1));
	DrawFingerBase(RightFinger);

	glm::mat4 RightTip = glm::translate(RightFinger, glm::vec3(0.0f, 0.35f, 0.0f));
	RightTip = glm::rotate(RightTip, glm::radians(-FingerAng2), glm::vec3(0, 0, 1));
