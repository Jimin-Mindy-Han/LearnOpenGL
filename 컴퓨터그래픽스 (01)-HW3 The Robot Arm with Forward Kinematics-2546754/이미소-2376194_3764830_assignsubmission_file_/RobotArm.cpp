...
void myDisplay()
{
	...
	// Base
	glm::mat4 base = model;
	base = glm::translate(base, glm::vec3(BaseTransX,0.0f,BaseTransZ));
	base = glm::rotate(base, glm::radians(BaseSpin), glm::vec3(0.0f,1.0f,0.0f));
	DrawBase(base);

	// Shoulder
	glm::mat4 shoulder = base;
	...
	// FingerBase1
	glm::mat4 finger1 = wrist;
	finger1 = glm::translate(finger1, glm::vec3(0.0f, 0.2f, 0.0f));
	finger1 = glm::rotate(finger1, glm::radians(FingerAng1), glm::vec3(0.0f, 0.0f, 0.1f));
	DrawFingerBase(finger1);


	//FingerBase2
	glm::mat4 finger2 = wrist;
	finger2 = glm::translate(finger2, glm::vec3(0.0f, 0.2f, 0.0f));
	finger2 = glm::rotate(finger2, glm::radians(FingerAng2), glm::vec3(0.0f, 0.13f, 0.07f));
	DrawFingerBase(finger2);

	// FingerTip1
	glm::mat4 fingertip1 = finger1;
	fingertip1 = glm::translate(fingertip1, glm::vec3(0.0f, 0.35f, 0.0f));
	fingertip1 = glm::rotate(fingertip1, glm::radians(FingerAng1), glm::vec3(1.0f, 0.0f, 0.0f));
	fingertip1 = glm::rotate(fingertip1, glm::radians(-90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerTip(fingertip1);

	// FingerTip2
	glm::mat4 fingertip2 = finger2;
	fingertip2 = glm::translate(fingertip2, glm::vec3(0.0f, 0.35f, 0.0f));
	fingertip2 = glm::rotate(fingertip2, glm::radians(FingerAng2), glm::vec3(0.0f, 0.0f, 1.5f));
	fingertip2 = glm::rotate(fingertip2, glm::radians(90.0f), glm::vec3(5.0f,0.0f,1.2f));
...
void initGL(GLFWwindow** window)
{
	...
	// --------------------
	* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "The Robot Arm someday you will find me caught beneath the land slight hig", NULL, NULL);
	if (window == NULL)
	{
