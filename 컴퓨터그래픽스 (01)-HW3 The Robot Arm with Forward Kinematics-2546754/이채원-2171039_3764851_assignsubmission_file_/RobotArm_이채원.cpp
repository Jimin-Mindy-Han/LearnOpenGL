...
void myDisplay()
{
	...
	glm::mat4 finb1 = glm::translate(wrist, glm::vec3(0.0f, 0.2f, 0.0f));
	finb1 = glm::rotate(finb1, glm::radians(FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
	glm::mat4 finb2 = glm::translate(wrist, glm::vec3(0.0f, 0.2f, 0.0f));
	finb2 = glm::rotate(finb2, glm::radians(-FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
	
	glm::mat4 fint1 = glm::translate(finb1, glm::vec3(0.0f, 0.35f, 0.0f));
	fint1 = glm::rotate(fint1, glm::radians(FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));

	glm::mat4 fint2 = glm::translate(finb2, glm::vec3(0.0f, 0.35f, 0.0f));
	fint2 = glm::rotate(fint2, glm::radians(-FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
	...
	DrawArmSegment(arm2);
	DrawWrist(wrist);
	DrawFingerBase(finb1);
	DrawFingerBase(finb2);
	DrawFingerTip(fint1);
	DrawFingerTip(fint2);
	////////////////////////////////////////////////////////////////////////////////////////////////
	////////////////////////////////////////////////////////////////////////////////////////////////
