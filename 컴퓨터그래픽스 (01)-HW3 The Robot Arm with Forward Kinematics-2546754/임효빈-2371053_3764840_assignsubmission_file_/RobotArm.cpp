...
void myDisplay()
{
	...
	glm::mat4 model_base_L = glm::rotate(model, glm::radians(FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerBase(model_base_L);
	glm::mat4 model_base_R = glm::rotate(model, glm::radians(-FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerBase(model_base_R);
	model_base_L = glm::translate(model_base_L, glm::vec3(0.0f, 0.35f, 0.0f));
	glm::mat4 model_fingertip_L = glm::rotate(model_base_L, glm::radians(FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerTip(model_fingertip_L);
	model_base_R = glm::translate(model_base_R, glm::vec3(0.0f, 0.35f, 0.0f));
	glm::mat4 model_fingertip_R = glm::rotate(model_base_R, glm::radians(-FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerTip(model_fingertip_R);
