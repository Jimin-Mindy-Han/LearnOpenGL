...
// local coordinate in wrist
glm::mat4 objLocalInWrist(1.0f); 
...
void myDisplay()
{
    ...
    glm::mat4 armSegment1 = glm::translate(base, glm::vec3(0.0f, 0.45f, 0.0f));
    armSegment1 = glm::rotate(armSegment1, glm::radians(ShoulderAng), glm::vec3(0, 0, 1));
    DrawArmSegment(armSegment1);

    glm::mat4 armSegment2 = glm::translate(armSegment1, glm::vec3(0.0f, 0.5f, 0.0f));
    armSegment2 = glm::rotate(armSegment2, glm::radians(ElbowAng), glm::vec3(0, 0, 1));
    DrawArmSegment(armSegment2);

    glm::mat4 wrist = glm::translate(armSegment2, glm::vec3(0.0f, 0.5f, 0.0f));
	...
	if (TeapotToggle)
	{
        if (!attachToWrist) 
		{
            objLocalInWrist = glm::inverse(wrist) * objectXform;
            attachToWrist = true;
        } else 
		{
            objectXform = wrist * objLocalInWrist;
            attachToWrist = false;
        }
        TeapotToggle = false;
    }
    DrawObject(attachToWrist ? (wrist * objLocalInWrist) : objectXform);

    glm::mat4 fingerBase1 = glm::translate(wrist, glm::vec3(0.0f, 0.2f, 0.0f));
    fingerBase1 = glm::rotate(fingerBase1, glm::radians(FingerAng1), glm::vec3(0, 0, -1));
    DrawFingerBase(fingerBase1);

	glm::mat4 fingerBase2 = glm::translate(wrist, glm::vec3(0.0f, 0.2f, 0.0f));
    fingerBase2 = glm::rotate(fingerBase2, glm::radians(FingerAng1), glm::vec3(0, 0, 1));
    DrawFingerBase(fingerBase2);

    glm::mat4 fingerTip1 = glm::translate(fingerBase1, glm::vec3(0.0f, 0.35f, 0.0f));
	fingerTip1 = glm::rotate(fingerTip1, glm::radians(FingerAng2), glm::vec3(0, 0, -1));
    DrawFingerTip(fingerTip1);
    
    glm::mat4 fingerTip2 = glm::translate(fingerBase2, glm::vec3(0.0f, 0.35f, 0.0f));
	fingerTip2 = glm::rotate(fingerTip2, glm::radians(FingerAng2), glm::vec3(0, 0, 1));
