...
glm::vec3 TeapotPos = glm::vec3(0.5f, 0.0f, 0.0f);
glm::vec3 prevArmPoint = glm::vec3(0.0f);
glm::vec3 ArmPoint = glm::vec3(0.0f);
...
void myDisplay()
{
	...
	glm::mat4 Base = glm::translate(glm::mat4(1.0f), glm::vec3(BaseTransX, 0.0f, BaseTransZ));
	...
	ArmPoint = glm::vec3(Wrist * glm::vec4(0.0f, 0.5f, 0.0f, 1.0f));

	if (FollowTeapot)
	{
		glm::vec3 delta = ArmPoint - prevArmPoint;
		TeapotPos += delta;
	}

	prevArmPoint = ArmPoint;

	glm::mat4 TeapotModel = glm::translate(glm::mat4(1.0f), TeapotPos);
	TeapotModel = glm::scale(TeapotModel, glm::vec3(0.08f));
	DrawObject(TeapotModel);
}
