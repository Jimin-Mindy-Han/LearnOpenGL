...
void myDisplay()
{
	...
	model = glm::rotate(model, glm::radians(WristTwistAng), glm::vec3(1.0f, 0.0f, 0.0f));
	DrawWrist(model);

	//Finger1
	glm::mat4 finger1 = model;
	finger1 = glm::translate(finger1, glm::vec3(0.1f, 0.3f, 0.0f));
	...
	//Finger2
	glm::mat4 finger2 = model;
	finger2 = glm::translate(finger2, glm::vec3(-0.1f, 0.3f, 0.0f));
