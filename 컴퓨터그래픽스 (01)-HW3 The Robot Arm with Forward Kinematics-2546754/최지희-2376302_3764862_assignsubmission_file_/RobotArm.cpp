...
void myDisplay()
{
	...
	// shoulder 그리기
	glm::mat4 shoulderModel = model;
	shoulderModel = glm::translate(shoulderModel, glm::vec3(0.0f, 0.5f, 0.0f));
	shoulderModel = glm::rotate(shoulderModel, glm::radians(ShoulderAng), glm::vec3(1, 0, 0));
	DrawArmSegment(shoulderModel);

	// elbow 그리기
	glm::mat4 elbowModel = shoulderModel;
	elbowModel = glm::translate(elbowModel, glm::vec3(0.0f, 0.5f, -0.05f)); 
	elbowModel = glm::rotate(elbowModel, glm::radians(ElbowAng), glm::vec3(1, 0, 0));
	DrawArmSegment(elbowModel);

	// wrist 그리기
	glm::mat4 wristModel = elbowModel;
	wristModel = glm::translate(wristModel, glm::vec3(0.0f, 0.5f, 0.0f)); 
	wristModel = glm::rotate(wristModel, glm::radians(WristAng), glm::vec3(1, 0, 0));
	wristModel = glm::rotate(wristModel, glm::radians(WristTwistAng), glm::vec3(0, 1, 0));
	DrawWrist(wristModel);

	// finger1 그리기
	glm::mat4 finger1 = wristModel;
	finger1 = glm::translate(finger1, glm::vec3(0.0f, 0.2f, 0.0f));
	finger1 = glm::rotate(finger1, glm::radians(FingerAng1), glm::vec3(1, 0, 0));
	DrawFingerBase(finger1);

	glm::mat4 fingerTip1 = finger1;
	fingerTip1 = glm::translate(fingerTip1, glm::vec3(0.0f, 0.35f, 0.0f));
	fingerTip1 = glm::rotate(fingerTip1, glm::radians(-80.0f), glm::vec3(1, 0, 0));
	DrawFingerTip(fingerTip1);

	// finger2 그리기
	glm::mat4 finger2 = wristModel;
	finger2 = glm::translate(finger2, glm::vec3(0.0f, 0.2f, 0.0f));
	finger2 = glm::rotate(finger2, glm::radians(FingerAng2), glm::vec3(1, 0, 0));
	DrawFingerBase(finger2);

	glm::mat4 fingerTip2 = finger2;
	fingerTip2 = glm::translate(fingerTip2, glm::vec3(0.0f, 0.35f, 0.0f));
	fingerTip2 = glm::rotate(fingerTip2, glm::radians(80.0f), glm::vec3(1, 0, 0));
