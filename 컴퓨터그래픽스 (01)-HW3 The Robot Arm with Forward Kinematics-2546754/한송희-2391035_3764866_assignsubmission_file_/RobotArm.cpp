...
void myDisplay()
{
	...
	model = glm::translate(model, glm::vec3(-0.56f+ BaseTransX, 0.0f, 0.0f+ BaseTransZ));
	model = glm::rotate(model, glm::radians(0.0f + BaseSpin), glm::vec3(0.0f, 1.0f, 0.0f));
	DrawBase(model);

	glm::mat4 joint1model = glm::translate(model, glm::vec3(0.0f, 0.4f, 0.0f));
	DrawJoint(joint1model);

	glm::mat4 armpart1model = glm::rotate(joint1model, glm::radians(-20.0f+ ShoulderAng), glm::vec3(0.0f, 0.0f, 1.0f));
	armpart1model = glm::translate(armpart1model, glm::vec3(0.0f, 0.0f, 0.0f));
	DrawArmSegment(armpart1model);
	DrawJoint(armpart1model);

	glm::mat4 joint2model = glm::translate(armpart1model, glm::vec3(-0.01f, 0.52f, 0.0f));
	DrawJoint(joint2model);
	
	glm::mat4 armpart2model = glm::rotate(joint2model, glm::radians(30.0f + ElbowAng), glm::vec3(0.0f, 0.0f, 1.0f));
	armpart2model = translate(armpart2model, glm::vec3(0.0f, 0.0f, 0.0f));
	DrawArmSegment(armpart2model);

	glm::mat4 joint3model = glm::translate(armpart2model, glm::vec3(0.0f, 0.5f, 0.0f));
	DrawJoint(joint3model);

	glm::mat4 wristmodel = glm::rotate(joint3model, glm::radians(0.0f+ WristAng), glm::vec3(0.0f, 0.0f, 1.0f));
	wristmodel= glm::rotate(wristmodel, glm::radians(0.0f + WristTwistAng), glm::vec3(0.0f, 1.0f, 0.0f));
	wristmodel = glm::translate(wristmodel, glm::vec3(0.0f, 0.0f, 0.0f));
	DrawWrist(wristmodel);

	//坷弗率 finger base
	glm::mat4 rightfingerbasemodel = glm::translate(wristmodel, glm::vec3(0.0f, 0.17f, 0.0f));
	rightfingerbasemodel = glm::rotate(rightfingerbasemodel, glm::radians(-100.0f + FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerBase(rightfingerbasemodel);
	//坷弗率 fingertip
	glm::mat4 rightfingertipmodel = glm::translate(rightfingerbasemodel, glm::vec3(0.0f, 0.35f, 0.0f));
	rightfingertipmodel = glm::rotate(rightfingertipmodel, glm::radians(0.0f- FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerTip(rightfingertipmodel);

	//哭率 finger base
	glm::mat4 leftfingerbasemodel = glm::translate(wristmodel, glm::vec3(0.0f, 0.17f, 0.0f));
	leftfingerbasemodel = glm::rotate(leftfingerbasemodel, glm::radians(70.0f- FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerBase(leftfingerbasemodel);
	//哭率 fingertip
	glm::mat4 leftfingertipmodel = glm::translate(leftfingerbasemodel, glm::vec3(0.0f, 0.35f, 0.0f));
	leftfingertipmodel = glm::rotate(leftfingertipmodel, glm::radians(0.0f+ FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerTip(leftfingertipmodel);
	
}
