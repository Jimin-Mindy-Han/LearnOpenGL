...
void myDisplay()
{
	...
	if (followWrist) {
    	glm::mat4 objModel = glm::translate(model, glm::vec3(0.0f, 0.25f, 0.0f));
    	objModel = glm::scale(objModel, glm::vec3(0.08f));
    	DrawObject(objModel);
	}

	glm::mat4 fingerL = glm::translate(model, glm::vec3(0.05f, 0.2f, 0.0f));
	fingerL = glm::rotate(fingerL, glm::radians(FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerBase(fingerL);

	glm::mat4 tipL = glm::translate(fingerL, glm::vec3(0.0f, 0.35f, 0.0f));
	tipL = glm::rotate(tipL, glm::radians(FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerTip(tipL);

	glm::mat4 fingerR = glm::translate(model, glm::vec3(-0.05f, 0.2f, 0.0f));
	fingerR = glm::rotate(fingerR, glm::radians(-FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerBase(fingerR);

	glm::mat4 tipR = glm::translate(fingerR, glm::vec3(0.0f, 0.35f, 0.0f));
	tipR = glm::rotate(tipR, glm::radians(-FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerTip(tipR);
