...
bool followRobotArm = false;
bool wasFollowingRobotArm = false;
glm::mat4 teapotOffsetMatrix;
...
void myDisplay()
{
	...
	glm::mat4 base = glm::translate(model, glm::vec3(BaseTransX, 0, BaseTransZ));
	base = glm::rotate(base, glm::radians(BaseSpin), glm::vec3(0.0f, 1.0f, 0.0f));
	DrawBase(base);
	
	glm::mat4 armSegment1 = base;
	armSegment1 = glm::translate(armSegment1, glm::vec3(0.0f, 0.4f, 0.0f));
	armSegment1 = glm::rotate(armSegment1, glm::radians(ShoulderAng), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawArmSegment(armSegment1);

	glm::mat4 armSegment2 = armSegment1;
	armSegment2 = glm::translate(armSegment2, glm::vec3(0.0f, 0.5f, 0.0f));
	armSegment2 = glm::rotate(armSegment2, glm::radians(ElbowAng), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawArmSegment(armSegment2);

	glm::mat4 wrist = armSegment2;
	...
	glm::mat4 fingerBase1 = wrist;
	fingerBase1 = glm::translate(fingerBase1, glm::vec3(0.0f, 0.2f, 0.0f));
	fingerBase1 = glm::rotate(fingerBase1, glm::radians(FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerBase(fingerBase1);

	glm::mat4 fingerBase2 = wrist;
	fingerBase2 = glm::translate(fingerBase2, glm::vec3(0.0f, 0.2f, 0.0f));
	fingerBase2 = glm::rotate(fingerBase2, glm::radians(-FingerAng1), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerBase(fingerBase2);

	glm::mat4 fingerTip1 = fingerBase1;
	fingerTip1 = glm::translate(fingerTip1, glm::vec3(0.0f, 0.35f, 0.0f));
	fingerTip1 = glm::rotate(fingerTip1, glm::radians(FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerTip(fingerTip1);

	glm::mat4 fingerTip2 = fingerBase2;
	fingerTip2 = glm::translate(fingerTip2, glm::vec3(0.0f, 0.35f, 0.0f));
	fingerTip2 = glm::rotate(fingerTip2, glm::radians(-FingerAng2), glm::vec3(0.0f, 0.0f, 1.0f));
	DrawFingerTip(fingerTip2);

	if (followRobotArm)
	{
		if (!wasFollowingRobotArm)
		{
			teapotOffsetMatrix = glm::inverse(wrist) * objectXform;
		}
		objectXform = wrist * teapotOffsetMatrix;
	}
	wasFollowingRobotArm = followRobotArm;
